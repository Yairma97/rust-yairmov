...
pub mod echo_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn unary_echo(
            ...
            let path = http::uri::PathAndQuery::from_static("/stream.Echo/UnaryEcho");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("stream.Echo", "UnaryEcho"));
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("stream.Echo", "ServerStreamingEcho"));
        ...
        pub async fn client_streaming_echo(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("stream.Echo", "ClientStreamingEcho"));
        ...
        > {
            ...
            let mut req = request.into_streaming_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("stream.Echo", "BidirectionalStreamingEcho"));
